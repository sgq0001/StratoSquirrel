...
DropSam = DigiPointDevice("COM6", 9600)
DropSam.open()
...
print("Drop Device Duo: 2 Glider - cuts at 200 and 700")
dropDeviceNumber = input("Select Drop Device (1,2,3, Duo): ")
...
while not checkDropNumber:
    if dropDeviceNumber == "1":
        ...
        checkDropNumber = True
    elif dropDeviceNumber == "Duo":
        DropBalloon = RemoteDigiPointDevice(DropBase, XBee64BitAddress.from_hex_string("0013A2004199939A"))
        DropBalloon2 = RemoteDigiPointDevice(DropBase, XBee64BitAddress.from_hex_string("0013A20041920D72"))
        checkDropNumber = True
    else:
...
def drop_buttonPushed():
    DropBase.send_data_64_16(XBee64BitAddress.from_hex_string("0013A2004199939A"), XBee16BitAddress.UNKNOWN_ADDRESS, "DROP")
    print("Top Dropping...")


def gs_bottonPushed():
    DropBase.send_data_64_16(XBee64BitAddress.from_hex_string("0013A20041920D72"), XBee16BitAddress.UNKNOWN_ADDRESS,
                             "DROP")
    print("Bottom Dropping...")
...
drop_button = QtGui.QPushButton('Top Dropping')
...
gs_button = QtGui.QPushButton('Bottom Dropping')
